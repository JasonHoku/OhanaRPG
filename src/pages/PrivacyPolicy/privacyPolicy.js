					...
					<Col width="100%" style={{ maxWidth: "750px" }}>
						<Card>
							<CardBody>
								...
								<ul>
									...
									<li>
										<p>
											...
											this Agreement) refers to PonoMap, 15 HALE MAKAI PL.
										</p>
									</li>
									<li>
										<p>
									...
									<li>
										<p>
											<strong>Website</strong> refers to PonoMap, accessible from{" "}
											<a
												href="https://ohana-rpg.web.app/"
												rel="external nofollow noopener"
												target="_blank"
											>
												https://ohana-rpg.web.app/
											</a>
										</p>
									</li>
									<li>
								...
								<ul>
									<li>
										<p>By email: admin@ohana-rpg.web.app</p>
									</li>
									<li>
										<p>
											By visiting this page on our website:{" "}
											<a
												href="https://ohana-rpg.web.app/dashboards/contact"
												rel="external nofollow noopener"
												target="_blank"
											>
												https://ohana-rpg.web.app/dashboards/contact
											</a>
										</p>
									</li>
									<li>
										<p>By phone number: 8083851775</p>
									</li>
									<li>
										<p>By mail: 15 HALE MAKAI PL</p>
									</li>
								</ul>
							</CardBody>
						</Card>
